# Web and multimedia applications developer — RESUME  

### About me
I am looking for an opportunity to grow as a frontend developer (also open to backend or fullstack tasks). I am confident with React (Turbopack/Next/Redux/Zustand), JavaScript/TypeScript, HTML, CSS, PHP. Open to remote work or local opportunities.  
...
Participation in the development of a Telegram WebApp (in progress) with consideration of the environment specifics for job search.
...
Development of the company website ooo-somaks.ru.
...
For more info visit my RESUME repo.
